...
<div>
    ...
    <section class="relative overflow-hidden py-20 px-4 text-center bg-gradient-to-b from-[#1A1A1A] to-canvas">
        ...
        <div class="relative max-w-2xl mx-auto">
            ...
            <p class="text-muted mb-8 text-lg">
                {{ __('ui.home.hero_subtitle', ['total' => number_format($total, 0, ',', '.')]) }}
            </p>
            ...
            <a href="{{ route('search') }}"
               class="flex items-center gap-3 max-w-lg mx-auto bg-surface border border-white/10 rounded-2xl px-5 py-3.5 hover:border-primary/50 transition-colors group">
                ...
                <span class="text-muted text-base group-hover:text-[#F5F5F5] transition-colors">{{ __('ui.home.search_placeholder') }}</span>
            </a>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-4 py-12">
        <h2 class="text-xl font-black mb-6">{{ __('ui.home.section_recent') }}</h2>
    ...
    <section class="max-w-7xl mx-auto px-4 pb-12">
        <h2 class="text-xl font-black mb-6">{!! __('ui.home.section_popular') !!}</h2>
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
    ...
    <section class="max-w-7xl mx-auto px-4 pb-16">
        <h2 class="text-xl font-black mb-6">{{ __('ui.home.section_categories') }}</h2>
